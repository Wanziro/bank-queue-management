...
from .views import home, GetAllBranches, UpdateNotification, notificationReq, About, login_request, logout_request, notificationReq, register, feedback, queue_request, AddClientToTheQueue, GetClientsOnTheQueue, UpdateClient, GetChartData
...
urlpatterns = [
    ...
    path('api/updatenotifications/', UpdateNotification.as_view(),
         name='api_update_notifications'),
